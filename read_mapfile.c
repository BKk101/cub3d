...
/*   Updated: 2020/11/16 00:29:44 by bk               ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	make_2darr(t_mapinfo *m_info, char *path)
{
	...
	g_i = -1;
	m_info->map = malloc(sizeof(char *) * m_info->rc.y);
	while (++g_i<m_info->rc.y)
		m_info->map[g_i] = (char *)malloc(m_info->rc.x);
